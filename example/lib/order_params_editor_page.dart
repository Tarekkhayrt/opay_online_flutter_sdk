...
class OrderParamsEditorPage extends StatefulWidget {
  ...
  const OrderParamsEditorPage({Key? key, required this.payParams})
      : super(key: key);
            ...
            child: Column(
              children: <Widget>[
                ...
                TextField(
                    controller: TextEditingController.fromValue(
                        TextEditingValue(
                            text: widget.payParams.payAmount.toString())),
                    onChanged: (v) {
                ...
                TextField(
                    controller: TextEditingController.fromValue(
                        TextEditingValue(
                            text: widget.payParams.productDescription)),
                    onChanged: (v) {
                ...
                TextField(
                    controller: TextEditingController.fromValue(
                        TextEditingValue(
                            text: widget.payParams.expireAt.toString())),
                    onChanged: (v) {
